...
int main() {
    ...
    sf::Sprite sprite, enemy_sprite, potracheno;
    sf::Image plain_image, water_image, mountain_image, castle_image, lair_image, light_image, heavy_image, plane_image, potracheno_image;
    ...
    sf::Texture plain_texture, water_texture, mountain_texture, castle_texture, lair_texture, light_texture, heavy_texture, plane_texture, potracheno_texture;
